...
public class EtudiantListeStageController implements Initializable {
	...
	@FXML
	public TableView<utilisateur.Etudiant> etudiantTable;
	@FXML
	private TableColumn<utilisateur.Etudiant, String> etudiantNomColumn;
	@FXML
	private TableColumn<utilisateur.Etudiant, String> etudiantPrenomColumn;
	@FXML
	private TableColumn<utilisateur.Etudiant, Integer> etudiantNumEtuColumn;
	@FXML
	private TableColumn<utilisateur.Etudiant, Void> etudiantCheckColumn;
	@FXML
	private TableColumn<utilisateur.Etudiant, Void> etudiantModifColumn;
	@FXML
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		etudiantSelectAll.selectedProperty().addListener(new ChangeListener<Boolean>() {
			...
			public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
				for (utilisateur.Etudiant etudiant : etudiantTable.getItems()) {
					if (newValue) {
